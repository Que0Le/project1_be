...
# )
from app.services.project1_item import create_bitmap_from_word
...
def iterfile():  
    with open("/home/queprocno/Desktop/project1_be/static/pil_text.bmp", mode="rb") as file_like:  
...
async def project1_get_next(
    ...
    dictword = await words_repo.get_1_random_dictword()
    print(dictword)
    return StreamingResponse(io.BytesIO(create_bitmap_from_word(dictword)), media_type="image/jpeg")
