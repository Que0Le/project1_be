...
@router.get(
    ...
    name="words:get-words-by-path-query",
)
async def get_words_by_path_query(
    word: str,
    words_repo: WordsRepository = Depends(get_repository(WordsRepository)),
) -> ListOfWordOutWithIdDate:
...
@router.get(
    ...
    name="words:get-word-by-id-by-query",
)
...
@router.post(
    ...
    name="words:create-new-dictword",
)
...
@router.put(
    ...
    name="words:update-existing-dictword-by-id",
)
...
@router.delete(
    ...
    name="words:delete-dictword-from-db",
)
